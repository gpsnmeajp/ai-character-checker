...
このリポジトリは、AIキャラクターの多角的な分析・診断・修復・変換・新規作成を行う **15個のスキルファイル群** である。  
...
```
skills/                         ← 全15スキル（各フォルダに SKILL.md）
  ai-character-checker-all-in-one/
    SKILL.md                    ← 統合版（12スキル分のルーティング＋リファレンス同梱）
...
| カテゴリ | スキル | 役割 |
|---------|--------|------|
| **統合** | `ai-character-checker-all-in-one` | 全13スキルを1ファイルに統合（claude.ai のスキル1つ制限対応） |
