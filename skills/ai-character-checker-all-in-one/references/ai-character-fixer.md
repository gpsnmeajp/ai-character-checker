...
| ファイル | 内容 | 読み込みタイミング |
|----------|------|-------------------|
| `references/ai-character-fixer--modification-catalog.md` | 10修正手法の適用条件・具体的手順・注意事項、モード別出力テンプレート、第IV象限への設計パターン集、P1〜P8・F1〜F6の個別対処法 | **ステップ4（修正実行）の前に読み込む。** SKILL.md本体には修正手法の概要しかなく、このファイルなしでは具体的な修正操作と出力生成ができない |
...
4. `references/ai-character-fixer--modification-catalog.md` を読み込む
