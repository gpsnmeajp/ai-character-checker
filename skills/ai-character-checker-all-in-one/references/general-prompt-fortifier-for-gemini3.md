...
| ファイル | 内容 | 読み込みタイミング |
|----------|------|-------------------|
| `references/general-prompt-fortifier-for-gemini3--theory-and-techniques.md` | 11技法の理論的背景、LLMが物語性生成器である原理、**Gemini 3固有の適応原理** | **Phase 3（11技法の適用）の前に読み込む。** 各技法のGemini 3適応ポイントはこのファイルにしかない |
| `references/general-prompt-fortifier-for-gemini3--output-guide.md` | セクション別の詳細設計ガイド、入出力例の作成フロー、**Gemini 3での考慮事項**、ガードレール出力テンプレート | **Phase 3で出力プロンプトを構成する際に読み込む。** セクション構造・入出力例のフォーマット・ガードレール出力はこのファイルにしかない |
...
> **詳細は `references/general-prompt-fortifier-for-gemini3--theory-and-techniques.md` を参照。**
...
Phase 3: 11技法の適用 + Gemini 3最適化
  9. `references/general-prompt-fortifier-for-gemini3--theory-and-techniques.md` と `references/general-prompt-fortifier-for-gemini3--output-guide.md` を読み込む
...
→ 出力テンプレートは `references/general-prompt-fortifier-for-gemini3--output-guide.md` のガードレール出力テンプレートを参照。
...
> `references/general-prompt-fortifier-for-gemini3--output-guide.md` を参照。**
